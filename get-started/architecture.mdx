...
flowchart TB
  ...
  subgraph external["ChangeGuard AI control plane (api.changeguard.ai)"]
...
flowchart LR
  ...
  boundary ==>|"transmitted"| cp["ChangeGuard AI control plane"]
```
...
| Cluster snapshots, change history, findings | ChangeGuard AI control plane | Powers dashboards, scoring, and audit trails. |
