...
To understand what stands behind a note like that — evidence, what the system knows and doesn't, and how to challenge it — read [How ChangeGuard AI Makes Decisions](/concepts/how-changeguard-decides).
