...
If — and only if — you enable [Autonomous Remediation](/autonomy/autonomy-model), ChangeGuard AI needs permission to act. That permission is deliberately narrow:
