...
| **Support level** | **GA.** |
| **Enforcement** | **BLOCK fails the check; HOLD never does.** `enforce_block: false` runs it purely advisory; whether a failed check stops a merge is your branch rule. |
