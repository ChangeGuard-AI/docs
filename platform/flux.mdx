...
ChangeGuard AI watches Flux CD custom resources directly via the Kubernetes API inside the cluster — no Flux API tokens required, and it works even on clusters the ChangeGuard AI control plane can't reach.
