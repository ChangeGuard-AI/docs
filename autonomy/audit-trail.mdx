...
<Note>
  Audit events and timelines are tenant-scoped like all ChangeGuard AI data. For platform-level authentication and API-access auditing, see [Compliance & Audit](/security/compliance).
</Note>