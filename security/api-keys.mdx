...
API keys authenticate agents and CI/CD integrations with the ChangeGuard AI backend. Keys start with `cg_` and are bcrypt-hashed before storage — ChangeGuard AI never stores or logs plaintext keys.
