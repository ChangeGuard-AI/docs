...
If you discover a security vulnerability in ChangeGuard, please report it to [**security@changeguard.ai**](mailto:security@changeguard.ai). We commit to acknowledging reports within 24 hours and providing a remediation timeline within 72 hours.