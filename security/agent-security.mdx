...
description: "How the ChangeGuard AI agent operates safely inside your cluster"
---

## Read-Only by Design

The ChangeGuard AI agent uses a Kubernetes `ClusterRole` with strictly read-only permissions. It can only `get`, `list`, and `watch` resources — it cannot create, modify, or delete anything in your cluster.
